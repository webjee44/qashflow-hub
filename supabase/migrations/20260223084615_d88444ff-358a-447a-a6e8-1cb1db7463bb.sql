...
-- Add "Virement intercompte" to the default categories in handle_new_user trigger
...
BEGIN
  ...
  -- Create organization with Pro plan and 7 days trial
  ...
  -- Create default categories for the company (including Virement intercompte)
