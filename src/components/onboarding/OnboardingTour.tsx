    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[9999] pointer-events-none">
        ...
        {targetPosition && (
          ...
          >
            <div className="w-full h-full rounded-xl ring-2 ring-cyan-400 ring-offset-4 ring-offset-transparent animate-pulse" />
          </motion.div>
        )}
        ...
        >
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl">
            {/* Close button */}
            <button
              onClick={skipTour}
          ...
          {targetPosition && (
            <div
              className="absolute w-4 h-4 bg-slate-900/95 border border-white/10 rotate-45"
              style={{
