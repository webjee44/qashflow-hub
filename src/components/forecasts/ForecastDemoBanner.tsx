...
import { useForecastDemoData } from '@/hooks/useForecastDemoData';

export function ForecastDemoBanner() {
  const { hasDemoData, isLoading, clearDemoData, isClearing } = useForecastDemoData();
