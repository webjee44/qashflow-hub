...
import { useCategoryBreakdown } from '@/hooks/useDashboardStats';
import { Skeleton } from '@/components/ui/skeleton';

export function CategoryBreakdown() {
  const { data, totalExpense, loading } = useCategoryBreakdown();
  ...
  if (loading) {
    return (
      ...
      >
        ...
        <Skeleton className="h-64 w-full rounded-full mx-auto" style={{ maxWidth: 200 }} />
      </motion.div>
    );
  }
