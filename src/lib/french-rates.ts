...
export function calculateDetailedCharges(
  ...
  const charges: DetailedCharges = {
    ...
    chomage: contractType === 'intern' || contractType === 'stage' || contractType === 'apprentissage' || contractType === 'apprentice' ? 0 : grossSalary * rates.employer.chomage,
    ags: contractType === 'intern' || contractType === 'stage' || contractType === 'apprentissage' || contractType === 'apprentice' ? 0 : grossSalary * rates.employer.ags,
    fnal: grossSalary * (isLarge ? rates.employer.fnal.large : rates.employer.fnal.small),
    formation: contractType === 'apprentissage' || contractType === 'apprentice' ? 0 : grossSalary * (isSmall ? rates.employer.formation.small : rates.employer.formation.large),
    apprentissage: contractType === 'apprentissage' || contractType === 'apprentice' ? 0 : grossSalary * rates.employer.apprentissage,
