  ...
  const ratioItems = [
    {
      ...
      description: '(CA - COGS) / CA • N\'inclut que les charges variables flaggées "Coût des ventes"',
    ...
    },
    {
      ...
      format: formatPercent,
      description: 'Résultat net / CA • Rentabilité après toutes charges et impôts',
    ...
    },
    {
      ...
      format: formatPercent,
      description: 'Résultat net / Capitaux propres • Rendement des fonds investis',
    ...
    },
    {
      ...
      format: formatRatio,
      description: 'Actifs courants / Passifs courants • Capacité à honorer les dettes CT (idéal > 1.5)',
    ...
    },
    {
      ...
      format: formatRatio,
      description: 'Dettes financières / Capitaux propres • Levier financier (idéal < 1)',
    ...
    },
    {
      ...
      description: 'EBE / Charges financières • Capacité à rembourser les intérêts (idéal > 3)',
