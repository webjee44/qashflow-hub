...
export function useRevenueStreams() {
  ...
  // ⚠️ Helpers retained ONLY for read-side compatibility outside the BP module.
  // Inside the BP module (Revenue page, P&L, exports), all totals MUST come
  // from `useRevenue()` — single source of truth backed by the financial engine.
